# Guide : configurer Tailscale pour le pont Ollama/Fogbound
...
votre nom de machine (sans quoi Fogbound, comme n'importe quel navigateur,
...
la machine sur le tailnet. Fogbound n'a besoin d'etre mis a jour qu'une
...
locale (texte et image) redevient indisponible et Fogbound bascule sur
