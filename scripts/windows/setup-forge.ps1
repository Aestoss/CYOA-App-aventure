<#
.SYNOPSIS
  Installs and starts Forge (stable-diffusion-webui-forge) for Fogbound's
...
.NOTES
  ...
  - Local image generation stays best-effort throughout Fogbound: a failure
...
.PARAMETER SdPort
  ...
  Fogbound's Settings in sync with this if you ever change it.
...
# other beyond what start-fogbound.ps1 already orchestrates.
