...
function buildTurnPrompt({ world, memoryFacts, characters, recentTurns, playerAction, activeCharacter, trackedItems, secretInfo }) {
...
module.exports = { buildWorldCreationPrompt, buildTurnPrompt, buildSummaryPrompt, buildImagePrompt, MASTER_PROMPT, skillLabel };
